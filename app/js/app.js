	...
	function($stateProvider, $locationProvider, $urlRouterProvider, helper) {
		...
		$stateProvider
			...
			.state('app.widgets', {
				...
				resolve: helper.resolveFor('loadBaiduMapsJS', function() {
					return loadBaiduMaps('2.0', 'eYf9sA6yVTFHlh9ytU4a0EYY');
				}, 'ui.map.baidu')
			})
			.state('app.buttons', {
				url: '/buttons',
...
App
	...
	.constant('APP_REQUIRES', {
		...
		scripts: {
			...
			'loadBaiduMapsJS': ['app/vendor/bmap/load-baidu-maps.js'],
		...
		modules: [{
			...
			name: 'ui.map.baidu',
			files: ['app/vendor/angular-ui-map/ui-map-baidu.js']
		}, {
			name: 'datatables',
...
// ----------------------------------- 
  ...
  $scope.radarOptions = {
    scaleShowLine : true,
    angbusShowLineOut : true,
    scaleShowLabels : false,
    scaleBeginAtZero : true,
    angbusLineColor : 'rgba(0,0,0,.1)',
    angbusLineWidth : 1,
...
var myApp = angular.module('myAppName', ['angbus']);
